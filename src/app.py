...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and matches for all skill levels",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["nathan@mergington.edu", "lisa@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Stretching, mindfulness, and wellness exercises",
    ...
    "Photography Club": {
        "description": "Learn composition, lighting, and photo editing techniques",
